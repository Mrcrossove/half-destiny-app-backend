...
export const env = {
  ...
  murronApiKey: process.env.MURRON_API_KEY || '',
  compatibilityApiUrl: process.env.COMPATIBILITY_API_URL || 'https://www.murron-omni.com/apps/api/v1/workflows/run',
  compatibilityApiKey: process.env.COMPATIBILITY_API_KEY || '',
  ...
  dayunApiKey: process.env.DAYUN_API_KEY || '',
