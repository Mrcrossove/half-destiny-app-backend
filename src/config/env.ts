...
export const env = {
  ...
  murronApiUrl: process.env.MURRON_API_URL || 'https://www.murron-omni.com/apps/api/v1/workflows/run',
  murronApiKey: process.env.MURRON_API_KEY || 'app-SNF2iQnn3TRDzK0Nkt95W2PQ',
  murronCurrentDate: process.env.MURRON_CURRENT_DATE || '丙午',
  dayunApiUrl: process.env.DAYUN_API_URL || 'https://www.murron-omni.com/apps/api/v1/workflows/run',
  dayunApiKey: process.env.DAYUN_API_KEY || 'app-bygb4gYS50Ka2aqF5HFxrwqd',
  murronTimeoutMs: Number(process.env.MURRON_TIMEOUT_MS || 300000),
